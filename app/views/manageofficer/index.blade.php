		...
		<div class="contact-grids">
            ...
            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr class="gradeA">
                                            ...
                                            <td>{{ $tampil -> alamat }}</td>
                                            <td>  
                                            <a href="{{URL::to("Manageofficer/" .$tampil->id. "/destroy")}}"><button class="btn btn-danger">Hapus</button>
                                            <a href="{{URL::to("Manageofficer/edit/".$tampil->id) }}"><button class="btn btn-warning">Edit</button></a></td>
                                        </tr>
                                    @endforeach 
                                    </tbody>
                                </table>
			...
			<div class="col-md-6 contact-right">
                ...
                <form method="post">
					...
					<div align="right">
                    <a href="{{URL::to("Manageofficer")}}"><button class="btn btn-primary">Create Officer</button></a>
                    </div>
				</form>
			</div>
